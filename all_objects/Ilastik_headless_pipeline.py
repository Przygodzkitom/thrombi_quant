...
for channel in channel_paths: 
    ...
    for file in files: 
        ...
        command2='ilastik.exe --headless --project=%s --raw_data=%s%s --prediction_maps=%s%s%s' %(project_obj_location, channel_path, file, channel_path, file_no_ext, "_Probabilities.h5") #replace 'ilastik.exe' with an appropriate executable file name depending on your system
